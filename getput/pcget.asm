...
;	2.0	5/11/17	Update for CPUVille system
	...
	;; Williams -- update for Z80 MBC with my mods

SIOACR:	EQU	000H		;2SIO port A control register
SIOADR:	EQU	001H		;2SIO port A data register
...
mHelp:	db	CR,LF,'PCGET 2.0a for CPUVille/GNR',CR,LF,LF
