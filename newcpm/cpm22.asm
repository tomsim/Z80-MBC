...
;                                    Z80-MBC
;-----------------------------------------------------------------------
iLoadMode   .equ    0   ; Set to 1 for iLoad mode, set to 0 for Track 0
;                       ; image generation
;-----------------------------------------------------------------------
;
; Needed *ONLY* if loading CP/M with iLoad (for testing)
;
#IF iLoadMode == 1

    .org    CBASE - 10  ; iLoad starting address
...
;   Set origin for CP/M
;
    .ORG    $E400   ; Origin for the Z80-MBC
;
...
;                                    Z80-MBC
;-----------------------------------------------------------------------
	; #include    "BIOS CPM22 - S050217 R300417.asm" ; Included CBIOS for the Z80-MBC
#include "BIOS.ASM"	
;
; Following jump table commented because already present in the "included" 
; CBIOS of the Z80-MBC
;-----------------------------------------------------------------------
